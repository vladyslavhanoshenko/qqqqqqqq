...
namespace TestingFramework.Pages
{
    public class DominosLoginPage : BasePage
    {
        ...
        public By RegisterButton = By.XPath("//button[contains(text(), 'Регистрация')]");
        ...
        public By SubmitRegistrationButton = By.XPath("//button[contains(text(), 'Зарегистрироваться')]");
        public By SuccesfulRegPopu = By.XPath("//h1[contains(text(), 'Ссылка на вход была отправлена на ваш email')]");
